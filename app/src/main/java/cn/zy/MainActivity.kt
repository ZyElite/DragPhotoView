...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.setClick(object : BiConsumer<AppCompatImageView, Int> {
    ...
    class Adapter : RecyclerView.Adapter<Adapter.Holder>() {
        ...
        private var mOnItemClickListener: BiConsumer<AppCompatImageView, Int>? = null

        fun setClick(mOnItemClickListener: BiConsumer<AppCompatImageView, Int>) {
